<div class="d-flex flex-column justify-content-center align-items-center mt-5 reveal-2">
    <p class="titre text-center mb-5">{{__('message.t1-contact')}}</p>
    <div class="background-contact w-75 bg-b">
        <form class="p-5" action="{{\LaravelLocalization::localizeURL('/')}}" method="POST">
            @csrf
            <div class="mb-3">
                <div class="mb-3">
                    <label for="exampleInputName" class="form-label color">{{__('message.h6-1')}}</label>
              ...
              <label for="exampleInputEmail1" class="form-label color">{{__('message.h6-2')}}</label>
            ...
            <div class="mb-3">
                <label for="exampleInputMessage" class="form-label color">{{__('message.h6-3')}}</label>
              ...
              <div class="d-flex justify-content-center">
                  <button type="submit" class="btn pl-4 pr-4" style="cursor: none" id="bg-button">{{__('message.btn-contact')}}</button>
              </div>
